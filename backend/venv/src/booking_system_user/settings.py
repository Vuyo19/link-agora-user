"""
Django settings for booking_system_user project.
...
CORS_ALLOW_ALL_ORIGINS = True  # Set this to False to specify allowed origins.
...
ROOT_URLCONF = 'booking_system_user.urls'
...
WSGI_APPLICATION = 'booking_system_user.wsgi.application'
